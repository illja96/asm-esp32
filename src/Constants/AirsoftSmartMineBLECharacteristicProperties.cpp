...
const uint32_t AirsoftSmartMineBLECharacteristicProperties::RuntimeInSec = BLECharacteristic::PROPERTY_READ | BLECharacteristic::PROPERTY_NOTIFY;
...
const uint32_t AirsoftSmartMineBLECharacteristicProperties::IsExploded = BLECharacteristic::PROPERTY_READ | BLECharacteristic::PROPERTY_NOTIFY;
